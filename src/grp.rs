...
impl Group {
    ...
    fn lookup<T, F>(t: &T, getgrfunc: F) -> io::Result<Option<Self>>
        where T: Sized,
        F: Fn(&T, *mut libc::group, *mut libc::c_char, libc::size_t, *mut *mut libc::group) -> i32 {
    ...
    pub fn lookup_name(name: &str) -> io::Result<Option<Self>> {
        Self::lookup(
            &name,
            |name: &&str, grp: *mut libc::group, buf: *mut libc::c_char, buflen: libc::size_t, result: *mut *mut libc::group| {
                unsafe {
    ...
    pub fn lookup_gid(gid: u32) -> io::Result<Option<Self>> {
        Self::lookup(
            &gid,
            |gid: &u32, grp: *mut libc::group, buf: *mut libc::c_char, buflen: libc::size_t, result: *mut *mut libc::group| {
                unsafe {
